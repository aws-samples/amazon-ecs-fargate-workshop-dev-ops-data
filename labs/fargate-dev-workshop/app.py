...
We will be commiting portions of this repo during this lab. To make it easier we will copy the used portions of the content to a seperate location.
...
In this lab we will connect to our Git repository, 
